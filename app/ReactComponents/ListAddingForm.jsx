...
export default function ListAddingForm(props) {
    ...
    return (
        <form action={HandleClick} className="text-2xl border-black-200 rounded-xl border-2 w-full max-w-[700px] h-17 flex justify-items-center items-center overflow-hidden ">
