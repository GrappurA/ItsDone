...
export default function StarProgressChart(props) {
    ...
    return (
        ...
        <div className="w-full max-w-[600px] h-[350] md:h-[340px] flex flex-col bg-[#cefffd] border-4 border-black rounded-2xl p-3 md:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
